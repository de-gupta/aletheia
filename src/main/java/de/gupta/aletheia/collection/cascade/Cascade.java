...
public sealed interface Cascade<E> permits Brook, Nadir
{
	...
	Collection<E> rescue(final Supplier<? extends Collection<? extends E>> revelation);

	Collection<E> rescue(final Collection<? extends E> manifestation);
